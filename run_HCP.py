...
from tensorflow.keras.layers import Lambda, Flatten, Activation, Dense, Input
...
checkpointer = keras.callbacks.ModelCheckpoint(monitor='val_accuracy', filepath=tmp_name,
